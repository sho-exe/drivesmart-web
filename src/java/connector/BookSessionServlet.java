...
public class BookSessionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String branch_location = request.getParameter("branchLocation");
            String lesson_type = request.getParameter("lessonType");

            if ("insert".equals(action)) {
                SessionBean session = new SessionBean(0, student_name, branch_location, lesson_type, "Booked");
